...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("nidhipradeepsheeba@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Nidhi@19");
		...
		WebElement option = options.stream().filter(s->s.findElement(By.cssSelector("span")).getText().equals("India")).findFirst().orElse(null);
		option.click();
